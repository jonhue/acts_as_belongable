...
This project and everyone participating in it is governed by the [acts_as_belongable Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code.
...
Thanks for contributing to acts_as_belongable!
